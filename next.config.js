...
module.exports = withPWA({
  ...
  env: {
    ...
    NEXT_PUBLIC_SITEKEY_RECAPTCHA: process.env.NEXT_PUBLIC_SITEKEY_RECAPTCHA
      ? process.env.NEXT_PUBLIC_SITEKEY_RECAPTCHA
      : '',
    NEXT_PUBLIC_ENABLE_PREMIUM_FEATURES: process.env
