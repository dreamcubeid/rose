...
const classesRegister = {
  ...
  passwordStrengthBarContainerClassName: styleForm.form_passwordStrengthBarContainer,
  passwordStrengthBarClassName: styleForm.form_passwordStrengthBar,
  passwordCriteriaListClassName:styleForm.form_criteriaList,
  passwordStrengthLabelClassName: styleForm.form_passwordStrengthLabel,
